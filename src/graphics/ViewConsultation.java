...
public class ViewConsultation extends JPanel {
	 ...
	 * @param clientTCP 
	 */
	public ViewConsultation(ClientTCP clientTCP) {
		...
		JLabel lblNewLabel = new JLabel("Afficher la liste des consultations");
		lblNewLabel.setFont(new Font("Sitka Text", Font.BOLD, 19));
		lblNewLabel.setBounds(311, 20, 469, 50);
		add(lblNewLabel);
		...
		Object[] column = {"ID_CONSULTATION","nom patient","prénom patient","nom personnel","prénom personnel","examen","date"};
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				clientTCP.exeTcp("select;;*;;consultation");
